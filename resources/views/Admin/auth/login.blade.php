        ...
        <div class="auth-inner my-2">
            ...
            <div class="card mb-0">
                <div class="card-body ">
                    ...
                    <h4 class="card-title mb-1 text-center">Chào mừng bạn đến với phần mềm quản trị của TruyenHayHt👋</h4>
                    ...
                    <form class="auth-login-form mt-2" method="POST" action="{{ route('admin.login') }}">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror"
                                   id="login-email" name="username" placeholder="" aria-describedby="login-email"
                        ...
                        <button type="submit" class="btn btn-info w-100" tabindex="4">Đăng nhập</button>
                    </form>
                </div>
            </div>
            <!-- /Login basic -->
